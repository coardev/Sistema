...
<html>
    ...
    <style>
        @page {
  size: 6.5cm 100cm; /*medidas en tamaño*/
}
        @charset "utf-8";
        /* CSS Document */
        body {
    ...
    <div class="zona_impresion">
        ...
        <table border="0" align="center" width="250px">
            <tr>
                ...
                .::<font size="3"><strong>Medicos Unidos Rancho Alegre</strong>::.<font size="3"><br>
                Zumpango, Estado de Mexico<br><font size="3">
                Recibo de Venta<br>
                </td>
            </tr>
            <tr>
            <td  align="center"><font size="3">{{$v->created_at}} </td>
            </tr>
            <tr>
            <td align="center"></td>
            </tr>
            <tr>
                ...
                <td align="center"><font size="3">Cliente: {{$v->nombre}}</td>
            </tr>
             <tr>
                <td align="center"><font size="3">Nº de venta: {{$v->id}}</td>
            </tr>    
        </table>
        @endforeach
        <br>
        ...
        <table border="0" align="center" width="180px">
            <tr>
                <td><font size="2">CANT.</td>
                <td><font size="2">ART.</td>
                <td><font size="2">IMPORTE</td>
            </tr>
            <tr>
            <td colspan="3">===============================</td>
            </tr>            
            ...
            <tr>
               @if($det->inventariable == 1)
                 ...
                 <td><font size="2">{{$det->articulo}}</td>
                 <td><font size="2">${{$det->cantidad*$det->precio4}}</td>

                  @elseif($det->inventariable == 2)
                  @if($det->cantidad1 == 0)
                  <td><font size="2">{{$det->kilogramos}}Kg</td>
                  @elseif($det->kilogramos == 0)
                  <td><font size="2">{{$det->cantidad1}}</td>
                  @endif
                  <td><font size="2">{{$det->articulo}}</td>
                  @if($det->cantidad1 == 0)
                  <td><font size="2">${{$det->precio5}}</td>
                  @elseif($det->kilogramos == 0)
                  <td><font size="2">${{$det->precio6}}</td>
                  @endif
               @elseif($det->inventariable == 3)
                   <td><font size="2">{{$det->cantidad2}}</td>
                   <td><font size="2">{{$det->articulo}}</td>
                   <td><font size="2">${{$det->cantidad2*$det->precio3}}</td>
               @endif
            </tr>
        @endforeach
            ...
            <td><b><font size="3">$ {{$v->total}}</b></td>
            </tr>
            <tr>
            <td>&nbsp;</td>
            <td><b><font size="3">Cambio:</b></td>
            <td><b><font size="3">$ {{$v->cambio}}</b></td>
            </tr>
            ...
            <tr>
            <td colspan="3"><font size="3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;¡Gracias por su compra!</td>
            </tr>
