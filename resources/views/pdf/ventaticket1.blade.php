...
<html>
    ...
    <title>Numero de Compra</title>
    <style>
        @page {
  size: 6.8cm 15cm; /*medidas en tamaño*/
    ...
    <div class="zona_impresion">
        ...
        <table border="0" align="center" width="250px">
            <tr>
                ...
                <font size="4"><strong>Medicos Unidos Rancho Alegre</strong>
            ...
            <tr>
                ...
                <font size="4"><strong>Recibo de Venta</strong>
            ...
            <tr>
            <td align="center"><font size="4"><strong>{{$v->created_at}}</strong></td> 
            </tr> 
            <tr>
            <td> </td> 
            </tr> 
            ...
            <td> </td> 
             ...
             <tr>
             <td align="center"><font size="4"><strong>Folio: {{$v->id}}</strong></td>
             </tr>
             <tr>
            <td> </td> 
            </tr> 
            ...
            <td> </td> 
             ...
             <tr>
             <td align="center"><font size="6"><strong>Total:$ {{$v->total}}</strong></td>
            ...
            <tr>
             <td align="center"><font size="3"><strong>Favor de Pasar a Caja a Realizar el Pago</strong></td>
