                                ...
                                <tr v-for="articulo in arrayArticulo" :key="articulo.id">
                                    ...
                                    <td v-if="!isHidden">
                                     <template v-if="articulo.inventariable === 1">
                                      ...
                                      <template v-if="articulo.inventariable === 2">
                                      <button type="button" class="btn btn-danger btn-sm" @click="abrirModal('articulo','restar',articulo)" disabled>
                                      -
                                      </button>
                                      </template>
                                    ...
                                    <template v-if="articulo.inventariable === 1">
                                    <td style="color: red" v-text="articulo.precio_proveedor1"></td>
                                    </template>
                                    <template v-if="articulo.inventariable === 2">
                                    <td style="color: red">N/A</td>
                                    </template>
                            ...
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="form-group row">
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <div class="col-md-3">
                                        <input type="number" v-model="precio_venta" v-bind:min="0" class="form-control" v-on:keypress="isNumber(event)" placeholder="">                                       
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-3">
                                        <input id="x4"  type="number" v-model="stock" v-bind:min="0" class="form-control" v-on:keypress="isNumber(event)"  placeholder="">                                        
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-3">
                                        <input id="x10" type="number" v-model="stock1" v-bind:min="1" v-on:keypress="isNumber(event)" @keyup.enter="actualizarArticulo1()" class="form-control" placeholder="">                                        
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-3">
                                        <input id="x10" type="number" v-model="stock2" v-bind:min="1" v-on:keypress="isNumber(event)" @keyup.enter="actualizarArticulo2()" class="form-control" placeholder="">                                        
                                    </div>
